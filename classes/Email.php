...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido .= "<p>Presiona aquí: <a href= '" . $_ENV['DOMAIN_URL'] ."/confirmar-cuenta?token=" . $this->token .
    ...
    public function enviarInstrucciones()
    {
        ...
        $contenido .= "<p>Presiona aquí: <a href= '" . $_ENV['DOMAIN_URL'] ."/recuperar?token=" . $this->token .
